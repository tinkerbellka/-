...
define gui.text_font = "unineuelight.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "unineuelight.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "gogoia2.ttf"
...
define gui.main_menu_background = Movie(play = 'gui/vid.mpeg', loop = True, size = (1920,1080))
define gui.game_menu_background = Movie(play = 'gui/vid.mpeg', loop = True, size = (1920,1080))
